...
import { Cr } from "./chunk-rahwxqh8.js";
...
import { Idn } from "./chunk-kge29183.js";
...
function g(u) {
  let i = y(10),
    { param: P, addMargin: b, shouldShowDot: l } = u,
    { thinking: p } = P;
  const c = b ? 1 : 0;
  let t;
  if (i[0] !== l)
  ...
  if (i[4] !== a)
    ((m = e(o, {
      ...
      flexGrow: 1,
      children: e(rs, { hint: Idn, children: a }),
    })),
      (i[4] = a),
      (i[5] = m));
  else m = i[5];
  let k;
  if (i[6] !== c || i[7] !== t || i[8] !== m)
    ((k = r(o, { flexDirection: "row", marginTop: c, width: "100%", children: [t, m] })),
      (i[6] = c),
      (i[7] = t),
      (i[8] = m),
      (i[9] = k));
...
export { g as AssistantNarrationSummaryMessage };
