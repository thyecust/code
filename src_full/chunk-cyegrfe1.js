...
import { Kxe, Wh, af } from "./chunk-d2kjbmng.js";
import "./chunk-5rcp9861.js";
import { WOe } from "./chunk-qpwbvc04.js";
...
import { Yp, aM } from "./chunk-363v60qm.js";
...
function I(s) {
  if ("status" in s && s.status === "forked")
    return e(xe, {
      height: 1,
      children: e(n, {
        children: e(pe, { children: [s.background ? "Running in the background" : "Done"] }),
      }),
    });
  let t = ["Successfully loaded skill"];
  if ("allowedTools" in s && s.allowedTools && s.allowedTools.length > 0) {
    let l = s.allowedTools.length;
    t.push(`${l} ${R(l, "tool")} allowed`);
  }
  if ("model" in s && s.model) t.push(s.model);
  return e(xe, { height: 1, children: e(n, { children: e(pe, { children: t }) }) });
}
function m(s, { tools: t, verbose: l }) {
  if (!s.length) return e(xe, { height: 1, children: e(n, { dimColor: !0, children: f }) });
  let a = l ? s : s.slice(-p),
    g = s.length - a.length,
    { lookups: d, inProgressToolUseIDs: c } = WOe(s.map((i) => i.data));
  return e(xe, {
    children: r(o, {
      ...
      children: [
        ...
        e(Wh, { count: g, unit: "tool use" }),
      ],
    }),
  });
}
function v(s, { progressMessagesForMessage: t, tools: l, verbose: a }) {
  return r(B, { children: [m(t, { tools: l, verbose: a }), e(Yp, {})] });
}
function w(s, { progressMessagesForMessage: t, tools: l, verbose: a }) {
  return r(B, { children: [m(t, { tools: l, verbose: a }), e(af, { result: s, verbose: a })] });
}
export {
