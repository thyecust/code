...
import { Fr, k1, Oie } from "./chunk-x722nt0q.js";
...
import { JVe } from "./chunk-vwnptv6d.js";
...
async function l(a, e) {
  if (!Fr()) return { type: "text", value: k1() ?? "Fast mode is not available" };
