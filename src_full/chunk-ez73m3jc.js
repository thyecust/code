...
import { gZe } from "./chunk-x722nt0q.js";
...
import { Gse, FK } from "./chunk-77152aqa.js";
...
async function f() {
  if ((kot(), await Promise.all([Gse(), FK()]), await gZe(), yi())) _1();
}
export { f as restoreGatewayAuthForFastPath };
