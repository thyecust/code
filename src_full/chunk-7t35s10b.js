...
// Version: 2.1.259
import { Ir, Hhe, wr } from "./chunk-vdb853cm.js";
...
import { YYe } from "./chunk-gyc9r9jx.js";
...
async function R(r, e) {
  ...
  do {
    let i;
    try {
      i = await Ei(r.client).request(
        { method: "resources/directory/read", params: { uri: e, ...(t && { cursor: t }) } },
        Hhe,
        { timeout: Ol() },
      );
    } catch (a) {
      if (s === 0 || !(a instanceof wr && a.code === Ir.InvalidParams)) throw a;
      return (
        Z(
          r.name,
  ...
  if (t) Z(r.name, `resources/directory/read ${e}: stopped at ${n} pages with more pending`);
  return o;
}
