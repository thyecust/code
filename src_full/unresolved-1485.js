...
import { elt } from "./chunk-pfhf9cdy.js";
...
var s = async (m, t) => {
  let { call: c } = await import("./_MISSING/chunk-6g8wx1cf.js"),
    a = await c(
      (l, p) =>
        m(
          l
...
${l}`
  ...
  if (a == null) return a;
  return r(o, { flexDirection: "column", children: [e(n, { dimColor: !0, children: elt }), a] });
};
export { s as call };
