...
import { BF, zue } from "./chunk-qpwbvc04.js";
...
async function a(t, e) {
  if (St()) return { type: "text", value: "Session keeps running. Use /stop to end it." };
  return (await T9(BF(e), { responseStreaming: zue(e) }, e.storageV5), { type: "skip" });
}
export { a as call };
