...
export {
  Xir as DefaultPolicyLimitsClientSlot,
  vvr as FAIL_CLOSED_SHADOW_CACHE_TTL_MS,
  Svn as POLICY_LIMITS_COLD_AWAIT_MS,
  wvn as PolicyLimitsClient,
  UPr as _resetPolicyLimitsForTesting,
  Tvn as clearPolicyLimitsCache,
  Evn as composePolicyLimitsClient,
  Tvr as defaultPolicyLimitsClientSlots,
  kvr as extractServerErrorFields,
  Avn as initializePolicyLimitsLoadingPromise,
  kvn as loadPolicyLimits,
  vvn as logPolicyLimitsCacheStateAtFirstPrompt,
  Hvn as primePolicyLimitsCache,
  c8t as recordPolicyLimitsStartupAwaitResult,
  aQe as refreshPolicyLimits,
  sQe as shouldAwaitPolicyLimitsOnStartup,
  jPr as startBackgroundPolling,
  GPr as stopBackgroundPolling,
  Dy as waitForPolicyLimitsToLoad,
};
