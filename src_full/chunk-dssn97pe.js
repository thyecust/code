...
import { eB, DC } from "./chunk-qpwbvc04.js";
...
import { dVe, fVe, pVe, kjn } from "./chunk-kzdwk24h.js";
...
async function r() {
  if (eB()) return (DC("user"), { type: "text", value: kjn() });
  let t = dVe("command");
  if (t === "unavailable") return { type: "text", value: pVe() };
  return { type: "text", value: fVe(t) };
}
export { r as call };
