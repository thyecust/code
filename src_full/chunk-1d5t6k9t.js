...
import { CZ, zIe } from "./chunk-6rkpsn9e.js";
...
var g = new RegExp(`<${CZ}>[\\s\\S]*?</${CZ}>\\n*`);
function h(b) {
  let t = y(8),
    { addMargin: A, param: M } = b,
    { text: s } = M,
    x;
  if (t[0] !== s) {
    let c = s.replace(g, "");
    x = c.startsWith(zIe) ? c.slice(zIe.length) : c;
    ((t[0] = s), (t[1] = x));
  } else x = t[1];
  let m = x;
  const d = A ? 1 : 0;
  let T;
  if (t[2] === p) ((T = e(n, { "aria-label": "fork:", dimColor: !0, children: Rb })), (t[2] = T));
  else T = t[2];
  let i;
  if (t[3] !== m)
    ((i = e(o, { paddingLeft: 1, children: e(n, { children: m }) })), (t[3] = m), (t[4] = i));
  else i = t[4];
  let B;
  if (t[5] !== d || t[6] !== i)
    ((B = r(o, {
