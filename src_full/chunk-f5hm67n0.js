...
import { V0t } from "./chunk-h2t8tda3.js";
import { alt } from "./chunk-e02a2b6g.js";
...
var i = async (n, t) => {
  let r = n.trim(),
    e = r ? V0t.of(t.session.host).take(r) : void 0;
  if (!e)
    return (
      X("info", "workflow_launch_exec_no_slot", {}),
      {
        type: "text",
        value:
  ...
  try {
    ...
    X("warn", "workflow_launch_settle_failed", {});
  }
  try {
    e.postResultLine(o.line);
  } catch {
    X("warn", "workflow_launch_result_post_failed", {});
  }
