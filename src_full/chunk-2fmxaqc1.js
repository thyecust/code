...
import { U, j } from "./chunk-w71cs9yg.js";
...
function D(m) {
  return m.kind === "plugin" ? `plugin:${m.name}@${m.marketplace}` : `server:${m.name}`;
}
function E(G) {
  let t = y(13),
    { channels: h, onAccept: d } = G,
    v;
  if (t[0] !== d)
    ((v = function l(T) {
      bb2: switch (T) {
  ...
  if (t[2] === p)
    ((x = e(n, {
      ...
      (b = e(n, { children: "Please use --channels to run a list of approved channels." })),
      (t[2] = x),
      (t[3] = b));
  else ((x = t[2]), (b = t[3]));
  let i;
  if (t[4] !== h) ((i = h.map(D).join(", ")), (t[4] = h), (t[5] = i));
  else i = t[5];
  let c;
  if (t[6] !== i)
    ((c = r(o, {
      ...
      gap: 1,
      children: [x, b, r(n, { dimColor: !0, children: ["Channels:", " ", i] })],
    })),
      (t[6] = i),
      (t[7] = c));
  else c = t[7];
