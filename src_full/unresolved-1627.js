...
export {
  VPt as DIFF_SIDEBAR_AUTO_OPEN_MIN_COLS,
  Iee as DIFF_SIDEBAR_MIN_COLS,
  qPt as DIFF_SIDEBAR_NO_GIT_MESSAGE,
  tUn as clearReplDiffPanelAutoOpen,
  Len as closeReplDiffTab,
  xen as consumeReplDiffPanelAutoOpen,
  Den as cycleDiffBaseMode,
  Bst as diffPanelCanMount,
  O_e as diffSidebarHasGitRepo,
  Pen as getPersistedDiffBaseMode,
  KPt as markReplDiffPanelAutoOpen,
  Ree as resetReplTabToConvo,
  YPt as shouldAutoOpenDiffSidebar,
  XPt as toggleReplDiffTab,
};
