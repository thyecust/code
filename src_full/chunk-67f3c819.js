...
* Make sure to click any buttons, links, icons, etc with the cursor tip in the center of the element. Don't click boxes on their edges unless asked.`,
    inputSchema: {
      ...
      properties: {
        ...
        duration: {
          ...
          minimum: 0,
          maximum: uan,
          description: `The number of seconds to wait. Required for \`wait\`. Maximum ${uan} seconds.`,
        },
        scroll_direction: {
          type: "string",
  ...
  },
  {
    ...
    description:
      ...
      "close the group's last tab, Chrome auto-removes the group \u2014 " +
...
export { VNt, YKe, qNt, KNt, azn, uan, xDe, lzn, XKe, vdt };
