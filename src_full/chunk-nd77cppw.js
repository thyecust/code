...
// Version: 2.1.259
import { z, QI } from "./chunk-x1rrg5j2.js";
...
function T() {
  if ($e(!1) || Boolean(a.IS_DEMO) || a.CLAUBBIT) return "skip";
  return Jo() && !ole() ? "trusted" : "ask";
}
async function B(s, i, t) {
  switch (i) {
    case "skip":
      if (!a.CLAUBBIT && Jo()) {
        QI(!0);
        let { primePlanSlugCollisions: o } = await import("./chunk-ka0vhbd2.js");
        o(t);
      }
      {
        let { capturePolicySnapshot: o } = await import("./chunk-qqzq8xv9.js");
        o();
      }
      return;
    case "trusted": {
      ...
      let [{ primePlanSlugCollisions: o }, { capturePolicySnapshot: r }] = await Promise.all([
        import("./chunk-ka0vhbd2.js"),
        import("./chunk-qqzq8xv9.js"),
      ]);
      (o(t), r());
      return;
    }
    case "ask": {
      let [{ AppRoot: o }, { TrustDialog: r }, { getCommands: n }] = await Promise.all([
          import("./chunk-4f07va6e.js"),
          import("./chunk-rawwsbga.js"),
          import("./commands__cand0.js"),
        ]),
        p = await n(ne(), t).catch(() => []);
      (await new Promise((k) => {
        s.render(
          e(
            o,
            { session: z(), storageV5: t, children: e(r, { commands: p, onDone: () => k() }) },
            "agents-trust",
          ),
        );
      }),
        QI(!0));
      let { clearPluginCache: c } = await import("./chunk-beh582h1.js");
...
export { T as agentsTrustDecision, B as ensureAgentsWorkspaceTrust };
