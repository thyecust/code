...
import { Jp } from "./chunk-heb0jh6b.js";
...
import { IT } from "./chunk-mrsbyrhq.js";
...
import { xrn, Lrn } from "./chunk-zc4vwevt.js";
...
var c = async (r, o) => {
  let i = r.trim() || void 0,
    e = Q();
  o.dialogStore?.dismissKind(Jp.kind);
  for await (let s of xrn({ ...o, clearedSessionTitle: i })) o.onQueryEvent?.(s);
  let a = IT(o.submissionOrigin) && !Lrn(o.taskRegistry.all());
  return (
    import("./chunk-jcvmsfw4.js")
