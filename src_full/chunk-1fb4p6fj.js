...
import { SVe, XLe, alt } from "./chunk-e02a2b6g.js";
import "./chunk-tx1a8k4e.js";
import "./chunk-ck77cnqt.js";
import "./chunk-4ft7fr94.js";
import { _Vn, tln } from "./chunk-vqmm06g2.js";
...
function e(s, t) {
  return { type: "text", value: SVe(s, t) };
}
var u = async (s, t) => {
  ...
  if (o === void 0 || o === "")
    return e(
      "env-missing",
      `${_Vn} is not set. This command is the deterministic entry point for sessions launched with an environment-delivered workflow script; it has no interactive use.`,
    );
  let i = XLe();
  ...
  if (r !== void 0 && r !== "") {
    if (r.length > ny) return e("args-too-large", `${tln} exceeds ${ny} bytes.`);
    try {
      l = JSON.parse(r);
    } catch (n) {
      return e(
        "args-parse",
        `${tln} is not valid JSON: ${n instanceof Error ? n.message : String(n)}`,
      );
    }
  }
  return {
    type: "text",
    value: (await alt({ script: o, args: l, telemetrySource: "remote_env", context: t })).line,
  };
};
export { d as ERROR_LAYERS, u as call, e as errorText };
