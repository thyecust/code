...
function I(q) {
  let t = y(27),
    { tierLabel: z, fromName: x, toName: i, toProviderId: N, onDone: l } = q;
  const P = `Newer ${z} model available`;
  let s;
  if (t[0] !== l) ((s = () => l(!1)), (t[0] = l), (t[1] = s));
  else s = t[1];
  let d;
  if (t[2] !== x)
    ((d = r(n, { children: ["Currently pinned: ", e(n, { bold: !0, children: x })] })),
      (t[2] = x),
      (t[3] = d));
  else d = t[3];
  let m;
  if (t[4] !== i) ((m = e(n, { bold: !0, children: i })), (t[4] = i), (t[5] = m));
  else m = t[5];
  let f;
  if (t[6] !== N) ((f = r(n, { dimColor: !0, children: ["(", N, ")"] })), (t[6] = N), (t[7] = f));
  else f = t[7];
  let c;
  if (t[8] !== m || t[9] !== f)
    ((c = r(n, { children: ["Latest available: ", m, " ", f] })),
      (t[8] = m),
      (t[9] = f),
      (t[10] = c));
  else c = t[10];
  ...
  let w;
  if (t[14] === p)
    ((w = e(n, { dimColor: !0, children: "Claude Code will restart to apply." })), (t[14] = w));
  else w = t[14];
  let g;
  if (t[15] !== i)
    ((g = r(n, { children: ["Update settings to use ", i, "?", " ", w] })),
      (t[15] = i),
      (t[16] = g));
  else g = t[16];
  let b;
  if (t[17] !== l)
    ((b = e(In, { onConfirm: () => l(!0), onCancel: () => l(!1) })), (t[17] = l), (t[18] = b));
  else b = t[18];
  let u;
  if (t[19] !== b || t[20] !== C || t[21] !== g)
  ...
  let B;
  if (t[23] !== P || t[24] !== u || t[25] !== s)
    ((B = e(me, { title: P, color: "permission", onCancel: s, children: u })),
      (t[23] = P),
      (t[24] = u),
      (t[25] = s),
      (t[26] = B));
...
export { I as ThirdPartyModelUpgradeDialog };
