...
import { W7, $5, dG } from "./chunk-meget4pa.js";
...
import { gS, ik, D5, Mwn, Own } from "./chunk-b9h3hrm9.js";
...
var n = m(() => nt({ id: i().describe("Job ID returned by CronCreate.") })),
  s = m(() => c({ id: i() })),
  C = kt({
    name: gS,
    ...
    async validateInput(e) {
      let r = (await dG()).find((a) => a.id === e.id);
    ...
    async call({ id: e }) {
      return (await $5([e]), { data: { id: e } });
    },
    mapToolResultToToolResultBlockParam(e, t) {
      return { tool_use_id: t, type: "tool_result", content: `Cancelled job ${e.id}.` };
    },
