...
async function l(r, o) {
  let t = St();
  if (!t) T7({ action: "logout", success: !0, authMethod: "oauth" });
  if ((await hz({ clearOnboarding: !0, storageV5: o.storageV5, credentials: o.credentials }), t))
    return (
      r(
  ...
  let s = e(n, { children: "Successfully logged out from your Anthropic account." });
  return (
    setTimeout(() => {
      Jr(0, "logout");
    }, 200),
