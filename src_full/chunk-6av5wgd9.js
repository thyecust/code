...
import { pQt, mQt } from "./chunk-nv0q3ger.js";
...
j();
function K(I) {
  return { label: r(n, { children: ["Use ", e(n, { bold: !0, children: $o(I) })] }), value: I };
}
function J(eo) {
  let g = y(19),
    { targetRepo: a, initialPaths: io, onSelectPath: V, onCancel: c, storageV5: x } = eo,
    [i, no] = d(io),
    [u, z] = d(null),
    [D, E] = d(!1),
    F;
  if (g[0] !== i || g[1] !== c || g[2] !== V || g[3] !== x || g[4] !== a)
    ((F = async (m) => {
      if (m === "cancel") {
        c();
        return;
      }
      if ((E(!0), z(null), await pQt(m, a))) {
        V(m);
        return;
      }
      mQt(a, m, x);
      let lo = i.filter((ao) => ao !== m);
      (no(lo),
        E(!1),
        z(`${$o(m)} no longer contains the correct repository. Select another path.`));
    }),
      (g[0] = i),
      (g[1] = c),
      (g[2] = V),
  ...
  if (g[6] !== i) {
    let l;
    if (g[8] === p) ((l = { label: "Cancel", value: "cancel" }), (g[8] = l));
    else l = g[8];
    G = [...i.map(K), l];
    ((g[6] = i), (g[7] = G));
  } else G = g[7];
  let R = G,
    l;
  if (g[9] !== i.length || g[10] !== u || g[11] !== M || g[12] !== R || g[13] !== a || g[14] !== D)
    ((l =
      i.length > 0
        ? r(B, {
            children: [
              r(o, {
                ...
                children: [
                  e(qr, { error: u }),
                  r(n, {
                    children: ["Open Claude Code in ", e(n, { bold: !0, children: a }), ":"],
                  }),
                ],
              }),
              D
                ? r(o, {
                    children: [e(To, {}), e(n, { children: " Validating repository\u2026" })],
                  })
                : e(Re, { options: R, onChange: (so) => void M(so) }),
            ],
          })
        : r(o, {
            flexDirection: "column",
            ...
            children: [
              e(qr, { error: u }),
              r(n, { dimColor: !0, children: ["Run claude --teleport from a checkout of ", a] }),
            ],
          })),
      (g[9] = i.length),
      (g[10] = u),
  ...
  let H;
  if (g[16] !== c || g[17] !== l)
    ((H = e(me, { title: "Teleport to Repo", onCancel: c, color: "background", children: l })),
      (g[16] = c),
      (g[17] = l),
      (g[18] = H));
  else H = g[18];
...
export { J as TeleportRepoMismatchDialog };
