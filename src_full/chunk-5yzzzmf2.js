...
import { Jyt, UV, l0 } from "./chunk-qpwbvc04.js";
...
import { U_e } from "./chunk-nf6vz5qa.js";
...
async function y({
  ...
  if (!l0()) return { feedback_id: null, failure_reason: "drafts_disabled" };
  let { queued: m } = await UV(void 0, n),
    o = m.find((b) => b.draft_id === f);
  if (!o) return { feedback_id: null, failure_reason: "draft_not_found" };
  let i = e !== void 0 && Jyt.includes(e) ? e : void 0,
    p = {
      ...o,
      ...(i !== void 0 && { type: i }),
      ...(r != null && r !== "" && { title: r }),
  ...
  return s.success ? { feedback_id: s.feedbackId } : { feedback_id: null, failure_reason: s.error };
}
