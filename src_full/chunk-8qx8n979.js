...
// Version: 2.1.259
import { yvr, n3, fk, Hie, APr, LAn, PG, _ir, wie, TT, _vr } from "./chunk-6dcxrmbt.js";
...
export {
  _ir as ManagedEnvApplier,
  yvr as PROJECT_SCOPE_BLOCKED_ENV_VARS,
  APr as _resetPreSettingsEnvSnapshotForTesting,
  _vr as _resetSpawnEnvSnapshotForTesting,
  TT as applyConfigEnvironmentVariables,
  wie as applySafeConfigEnvironmentVariables,
  PG as filterPolicyPredicateEnv,
  Hie as getAppliedGlobalConfigEnv,
  fk as getLatchedPreSettingsEnvSnapshot,
  n3 as getPreSettingsEnvSnapshot,
  LAn as resetPreSettingsEnvSnapshotForClaim,
};
