...
import { Xd } from "./chunk-eza32dw3.js";
import "./chunk-7bh7nxpg.js";
import { XEe, wB, ic, iA, Mm, g0, v6e, FR } from "./chunk-qpwbvc04.js";
...
import { _F } from "./chunk-v0f7mjwn.js";
...
async function S(a, n, r) {
  if (a.length === 0) {
    let s = [
      ...
      ...(JC()
        ? [{ value: "stats", description: "Show skill usage and context costs", isFinal: !0 }]
        : []),
    ];
    return c(s, n);
  }
  ...
  if (a.length === 1)
    switch (l) {
      ...
      case "uninstall": {
        let s = Mm(),
          i = Object.entries(s.plugins).filter(([, t]) => t.some(g0));
        ...
        let e = i
          .map(([t, o]) => {
            let u = (o.find(g0) ?? o[0])?.version;
            return { value: t, description: v6e(u), isFinal: !0 };
          })
      ...
      case "i": {
        ...
        return c(await f(g.of(z().host), r), n);
      }
      case "list":
      case "ls":
        return c(p, n);
  ...
  if (a.length === 2 && (l === "marketplace" || l === "market")) {
    ...
    if (s === "remove" || s === "rm" || s === "update") {
      let i = await ic(r),
        e = Object.entries(i)
          .map(([t, o]) => ({ value: t, description: XEe(o.source), isFinal: !0 }))
          .sort((t, o) => t.value.localeCompare(o.value));
      return c(e, n);
    }
  }
...
async function f(a, n) {
  let r = await ic(n),
    ...
    i = a.get(s);
  if (i === void 0) {
    let e = await Promise.all(l.map(async (t) => ({ name: t, marketplace: await iA(t, n) })));
    i = [];
    for (let { name: t, marketplace: o } of e) {
      if (!o) continue;
      for (let u of o.plugins) i.push({ pluginId: wB(u.name, t), description: u.description });
    }
    (i.sort((t, o) => t.pluginId.localeCompare(o.pluginId)), a.store(s, i));
  }
  return i
    .filter((e) => !FR(e.pluginId) && !Xd(e.pluginId))
...
export { g as availablePluginCandidatesMemos, S as getPluginArgumentCompletions };
