...
// Version: 2.1.259
import { CD, mL, SF } from "./chunk-4agzgpwt.js";
...
var a = H(function (m) {
  ...
  })((d = m.AggregationTemporalityPreference || (m.AggregationTemporalityPreference = {})));
});
var u = H(function (O) {
  ...
  function b() {
    let e = (
      (0, f.getStringFromEnv)("OTEL_EXPORTER_OTLP_METRICS_TEMPORALITY_PREFERENCE") ?? "cumulative"
    ).toLowerCase();
  ...
  function B(e) {
    if (e != null) {
      if (e === E.AggregationTemporalityPreference.DELTA) return O.DeltaTemporalitySelector;
...
var A = H(function (s) {
  ...
  Object.defineProperty(s, "OTLPMetricExporter", {
    enumerable: !0,
    get: function () {
      return V.OTLPMetricExporter;
    },
  });
});
var ylt = H(function (t) {
  ...
  Object.defineProperty(t, "AggregationTemporalityPreference", {
    enumerable: !0,
    get: function () {
      return F.AggregationTemporalityPreference;
    },
  });
  var i = u();
