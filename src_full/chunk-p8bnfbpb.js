...
// Version: 2.1.259
import { go, Ze } from "./chunk-x1rrg5j2.js";
...
import { jH, bc, hx } from "./chunk-x722nt0q.js";
...
import { gNt, tWn } from "./chunk-6wna9z6m.js";
...
async function v(e, o, s) {
  if (
    (await iAe(go(e), { agentType: o.agentType, isObserver: !0 }, s),
    (await zv(go(e), s))?.isObserver !== !0)
  )
...
var b = {
  async spawnFirstRun({
    ...
    let n = o.observerTaskId,
      d = r.session.withProject({ cwd: ne() });
    await v(n, e, r.storageV5);
    let { taskRegistry: p } = r,
      m = fe(r),
      g = fW(o.armingPermissionMode, m.mode) ?? m.mode,
      c = { ...m, mode: g },
      w = r.options.tools.filter(Yh),
      l = `${e.agentType}@${o.observedEnvelopeName}`,
      i = bc(r.agentContext) + 1,
      A = gNt(rA(e, u0(c, fG(w), { skipReplFilter: !0 }), !0, !1, !1, i).resolvedTools),
      u = xR(e.model, r.options.mainLoopModel, void 0, c.mode),
      y = F8({
        agentId: n,
        ownerAgentId: Ze(),
        spawnDepth: i,
    ...
    let T = {
        ...
        isAsync: !0,
        source: e.source,
        pluginId: PX(e) ? Zt(e.plugin) : void 0,
      },
      k = {
        agentId: n,
        ...
        NV({
          ...
          makeStream: (S, I, M) =>
            vH({
              ...
              promptMessages: [
                Ie({ content: s }),
                Ie({ content: a, origin: { kind: "observer-activity" } }),
              ],
              toolUseContext: r,
              canUseTool: f,
              isAsync: !0,
              querySource: pV(e.agentType, ja(e)),
              availableTools: A,
              useExactTools: !0,
              session: d,
              spawnMode: g,
              override: { agentId: go(n), abortController: y.abortController },
              onModelRestricted: yre(e.agentType, r.appendSystemMessage),
              onCacheSafeParams: S,
              onQueryProgress: I,
...
function x(e) {
  try {
    ...
    t(`[agentObserver] spawner registration failed: ${o}`);
  }
}
export { x as installObserverSpawner, b as spawner };
