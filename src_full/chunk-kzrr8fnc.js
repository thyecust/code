...
import { tj } from "./chunk-btzpqxnm.js";
import { G6, ree, Kye, gQt, hQt } from "./chunk-nv0q3ger.js";
...
function _(Q) {
  return e(tj, { status: "pending", label: Q }, Q);
}
function X(mt) {
  let t = y(26),
    { state: a, cancelling: x, onCancel: g } = mt,
    { columns: N } = He(),
    [R, ut] = d(Y),
    O;
  if (t[0] === p) ((O = () => ut(Date.now())), (t[0] = O));
  else O = t[0];
  Oo(O, 1000);
  let z;
  if (t[1] !== a) ((z = Kye(a)), (t[1] = a), (t[2] = z));
  else z = t[2];
  let c = z === "created",
    E;
  if (t[3] !== g) ((E = { "app:interrupt": g, "app:exit": g }), (t[3] = g), (t[4] = E));
  else E = t[4];
  let dt = E;
  const B = !c;
  let F;
  if (t[5] !== B) ((F = { context: "Global", isActive: B }), (t[5] = B), (t[6] = F));
  else F = t[6];
  pt(dt, F);
  let H;
  if (t[7] === p) ((H = G6(0).steps.map(Z)), (t[7] = H));
  else H = t[7];
  let ft = H,
    k;
  if (t[8] !== a) ((k = hQt(a)), (t[8] = a), (t[9] = k));
  else k = t[9];
  let h;
  if (t[10] !== k) ((h = e(n, { bold: !0, children: k })), (t[10] = k), (t[11] = h));
  else h = t[11];
  let v;
  if (t[12] !== N || t[13] !== R || t[14] !== a)
    ((v = a.steps.map((I) => e(D, { step: I, state: a, now: R, columns: N }, I.id))),
      (t[12] = N),
      (t[13] = R),
      (t[14] = a),
      (t[15] = v));
  ...
  let S;
  if (t[16] !== c) ((S = !c && ft.map(_)), (t[16] = c), (t[17] = S));
  else S = t[17];
  let T;
  if (t[18] !== x || t[19] !== c)
    ((T =
      ...
      e(o, {
        ...
        children: e(n, {
          ...
          children: r(pe, {
            children: [
              e(n, {
                children: x ? "Cancelling\u2026" : "Typing is paused until the prompt opens",
              }),
              e(Ke, {
                action: "app:interrupt",
                context: "Global",
                fallback: "ctrl+c",
                description: x ? "quit now" : "cancel",
              }),
            ],
          }),
        }),
  ...
  let J;
  if (t[21] !== S || t[22] !== T || t[23] !== h || t[24] !== v)
    ((J = r(o, { flexDirection: "column", marginTop: 1, children: [h, v, S, T] })),
      (t[21] = S),
      (t[22] = T),
      (t[23] = h),
      (t[24] = v),
...
function D(bt) {
  let U = y(10),
    { step: f, state: G, now: P, columns: q } = bt,
    V;
  if (U[0] !== P || U[1] !== G || U[2] !== f)
    ((V = gQt(f, G, P)), (U[0] = P), (U[1] = G), (U[2] = f), (U[3] = V));
  else V = U[3];
  let i = V,
    W;
  if (
