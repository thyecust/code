...
var h = 1e4,
  d = m(() =>
    nt({
      channel: i().max(256).optional().describe("Not available in this build; leave unset."),
      q: i().max(256).optional().describe("Not available in this build; leave unset."),
    }),
  ),
  S = m(() => c({ listing: i().describe("Formatted list of reachable agents") })),
  A = kt({
    name: Ys,
    aliases: [rrr],
    ...
    async call(t, e) {
      let {
          listAllPeers: n,
          formatForModel: r,
          buildSubagentExtras: a,
        } = import.meta.require("./chunk-650etm0d.js"),
        o = t.channel?.trim() || void 0,
        l = t.q?.trim() || void 0,
        [s, u] = await Promise.all([
          n(e.session, { channel: o, q: l, storageV5: e.storageV5 }, e.credentials),
          a(e, dH(e)),
        ]);
      return { data: { listing: r(s.peers, u, s) } };
    },
    mapToolResultToToolResultBlockParam(t, e) {
      return { tool_use_id: e, type: "tool_result", content: t.listing };
    },
  });
export { A as ListAgentsTool };
