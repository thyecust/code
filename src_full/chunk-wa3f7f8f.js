...
import { Cs, Wd, Vo, Nr } from "./chunk-qpwbvc04.js";
...
function b(q) {
  let l = y(23),
    { notebook_path: a, cell_id: g, new_source: k, cell_type: N, edit_mode: w, verbose: U } = q,
    u = w === void 0 ? "replace" : w,
    _ = u === "delete" ? "delete" : `${u} cell in`,
    F;
  if (l[0] !== a || l[1] !== U) ((F = U ? a : $o(a)), (l[0] = a), (l[1] = U), (l[2] = F));
  else F = l[2];
  let j = F,
    R;
  if (l[3] !== _)
    ((R = r(n, { color: "subtle", children: ["User rejected ", _, " "] })), (l[3] = _), (l[4] = R));
  else R = l[4];
  let T;
  if (l[5] !== j || l[6] !== a)
    ((T = e(n, { bold: !0, color: "subtle", children: e(jg, { filePath: a, children: j }) })),
      (l[5] = j),
      (l[6] = a),
      (l[7] = T));
  else T = l[7];
  let P;
  if (l[8] !== g) ((P = g ? Wd(Vo(Cs(g))) : ""), (l[8] = g), (l[9] = P));
  else P = l[9];
  let h;
  if (l[10] !== P)
    ((h = r(n, { color: "subtle", children: [" at cell ", P] })), (l[10] = P), (l[11] = h));
  else h = l[11];
  let x;
  if (l[12] !== R || l[13] !== T || l[14] !== h)
    ((x = r(o, { flexDirection: "row", children: [R, T, h] })),
      (l[12] = R),
      (l[13] = T),
      (l[14] = h),
      (l[15] = x));
  ...
  if (l[16] !== N || l[17] !== u || l[18] !== k)
    ((M =
      ...
      e(o, {
        ...
        children: e(Gh, {
          code: Cs(k),
          filePath: N === "markdown" ? "file.md" : "file.py",
          dim: !0,
        }),
      })),
      (l[16] = N),
  ...
  let L;
  if (l[20] !== x || l[21] !== M)
    ((L = e(xe, { children: r(o, { flexDirection: "column", children: [x, M] }) })),
      (l[20] = x),
      (l[21] = M),
      (l[22] = L));
  else L = l[22];
...
function oe(
  { notebook_path: t, cell_id: s, new_source: i, cell_type: c, edit_mode: m },
  { verbose: p },
) {
  ...
  if (p) {
    ...
    return r(B, {
      children: [
        e(jg, { filePath: t, children: f }),
        `@${d}, content: ${v}\u2026, cell_type: ${c}, edit_mode: ${m ?? "replace"}`,
      ],
    });
  }
  return r(B, { children: [e(jg, { filePath: t, children: f }), `@${d}`] });
}
function re(t, { verbose: s }) {
  return e(b, {
    notebook_path: t.notebook_path,
    cell_id: t.cell_id,
    new_source: t.new_source,
    cell_type: t.cell_type,
    edit_mode: t.edit_mode,
    verbose: s,
  });
}
function te(t, { verbose: s }) {
  if (!s && typeof t === "string" && Nr(t, "tool_use_error"))
    return e(xe, { children: e(n, { color: "error", children: "Error editing notebook" }) });
  return e(af, { result: t, verbose: s });
}
function se({ cell_id: t, new_source: s, error: i }) {
  if (i) return e(xe, { children: e(n, { color: "error", children: Cs(i) }) });
  return e(xe, {
    children: r(o, {
      flexDirection: "column",
      children: [
        r(n, {
          children: [
            "Updated cell",
            " ",
            e(n, { bold: !0, children: t ? Wd(Vo(Cs(t))) : "" }),
            ":",
          ],
        }),
        e(o, { marginLeft: 2, children: e(Gh, { code: Cs(s), filePath: "notebook.py" }) }),
      ],
    }),
  });
}
export {
  ...
  te as renderToolUseErrorMessage,
  oe as renderToolUseMessage,
  re as renderToolUseRejectedMessage,
};
