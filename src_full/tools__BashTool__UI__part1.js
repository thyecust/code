...
`);
      ...
      return r(n, { children: [s.trim(), "\u2026"] });
    }
  }
  return m;
}
function N(l, { verbose: a, tools: u, terminalSize: g, inProgressToolCallCount: m }) {
  let i = l.at(-1);
  if (!i || !i.data)
...
function w(l, a, { verbose: u, theme: g, tools: m, style: i }) {
  ...
  return r(o, {
    ...
    children: [
      s !== "" ? e(Hy, { content: s, verbose: u }) : null,
      c.trim() !== "" ? e(Hy, { content: c, verbose: u, isError: !0 }) : null,
      s === "" && c.trim() === ""
        ? e(xe, {
            height: 1,
            children: e(n, {
        ...
        : null,
      p ? e(xe, { children: e(az, { timeoutMs: p }) }) : null,
    ],
  });
}
function v(l, { verbose: a, progressMessagesForMessage: u, tools: g }) {
  return e(af, { result: l, verbose: a });
}
export {
  w as renderToolResultMessage,
  v as renderToolUseErrorMessage,
  I as renderToolUseMessage,
  N as renderToolUseProgressMessage,
  k as renderToolUseQueuedMessage,
};
