...
function Y(ie) {
  let i = y(52),
    ...
    a = Rs(),
    { refusedWithin: c, noteRefused: d, epoch: se } = si(),
    Q;
  ...
  if (
    ...
    let s;
    if (i[30] !== f)
      ((s = r(n, { children: ["Proceed against ", e(n, { bold: !0, children: f }), "?"] })),
        (i[30] = f),
        (i[31] = s));
    else s = i[31];
    if (i[32] !== t || i[33] !== s)
      ((h = r(o, { flexDirection: "column", gap: 1, children: [t, s] })),
        (i[32] = t),
        (i[33] = s),
        (i[34] = h));
    else h = i[34];
  ...
  let s;
  if (i[45] !== v || i[46] !== b || i[47] !== R || i[48] !== x || i[49] !== h || i[50] !== t)
    ((s = r(v, { title: b, onCancel: R, color: x, children: [h, t] })),
      (i[45] = v),
      (i[46] = b),
      (i[47] = R),
      (i[48] = x),
