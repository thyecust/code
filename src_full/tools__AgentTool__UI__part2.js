...
import { Cs, Vo, a_t, Nr } from "./chunk-qpwbvc04.js";
...
function b({ file_path: o, offset: t, limit: s, pages: l }, { verbose: c }) {
  if (!o) return null;
  if (a_t(o)) return "";
  let i = c ? o : $o(o);
  if (l)
    return r(B, {
      children: [e(jg, { filePath: o, children: i }), ` \xB7 pages ${Vo(Cs(`${l}`))}`],
    });
  if (c && (t || s)) {
    let a = t ?? 1,
      f = s ? `lines ${a}-${a + s - 1}` : `from line ${a}`;
    return r(B, { children: [e(jg, { filePath: o, children: i }), ` \xB7 ${f}`] });
  }
  return e(jg, { filePath: o, children: i });
}
function k({ file_path: o }) {
  let t = o ? a_t(o) : null;
  if (!t) return null;
  return r(n, { dimColor: !0, children: [" ", t] });
}
function F(o) {
  switch (o.type) {
    case "image": {
      let { originalSize: t } = o.file,
        s = Bt(t);
      return e(xe, { height: 1, children: r(n, { children: ["Read image (", s, ")"] }) });
    }
    case "notebook": {
      let { cells: t } = o.file;
      if (!t || t.length < 1)
        return e(n, { color: "error", children: "No cells found in notebook" });
      return e(xe, {
        height: 1,
        children: r(n, { children: ["Read ", e(n, { bold: !0, children: t.length }), " cells"] }),
      });
    }
    case "pdf": {
      let { originalSize: t } = o.file,
        s = Bt(t);
      return e(xe, { height: 1, children: r(n, { children: ["Read PDF (", s, ")"] }) });
    }
    case "parts":
      return e(xe, {
        height: 1,
        children: r(n, {
          children: [
            "Read ",
            e(n, { bold: !0, children: o.file.count }),
            " ",
            o.file.count === 1 ? "page" : "pages",
            " (",
            Bt(o.file.originalSize),
            ")",
          ],
        }),
      });
    case "text": {
      let { numLines: t } = o.file;
      return e(xe, {
        height: 1,
        children: r(n, {
          children: ["Read ", e(n, { bold: !0, children: t }), " ", t === 1 ? "line" : "lines"],
        }),
      });
    }
    case "file_unchanged":
      return e(xe, {
        ...
        children: e(n, {
          ...
          children:
            o.source === "seeded"
              ? `Already in context (${Vo(Cs(g(o.file.filePath)))})`
              : "Unchanged since last read",
        }),
      });
  }
}
function y(o, { verbose: t }) {
  if (!t && typeof o === "string") {
    if (o.includes(WI))
      return e(xe, { children: e(n, { color: "error", children: "File not found" }) });
    if (Nr(o, "tool_use_error"))
      return e(xe, { children: e(n, { color: "error", children: "Error reading file" }) });
  }
  return e(af, { result: o, verbose: t });
}
export {
