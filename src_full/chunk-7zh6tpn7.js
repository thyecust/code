...
async function d(i, t) {
  let r = i[0] || P,
    n = `${r}.pid`,
    s = t();
  import("./chunk-jrjxgpp0.js");
  for (let o of nce) delete process.env[o];
  try {
...
`),
  ...
  (process.off("uncaughtException", a), e(), await s, await vot(m, s));
}
function w(i, t = () => import("./chunk-f7m7ykk9.js")) {
  return d(i, t);
}
