...
function ne(ge) {
  let t = y(22),
    ...
    J;
  if (t[0] === p) ((J = { kind: "deciding" }), (t[0] = J));
  else J = t[0];
  let [G, K] = d(J),
    L = k(!1),
    M;
      ...
      return (
        b()
          ...
          .then((c) => {
            ...
            if ((A(c), !c.offer && c.line !== null && z.has(c.reason)))
              K({ kind: "notice", offer: c, line: c.line });
            else o(c);
          }),
        () => {
          U = !1;
  ...
  if ((v(Q, V), G.kind === "deciding")) {
    let l;
    if (t[8] === p) ((l = e(C, {})), (t[8] = l));
    else l = t[8];
    return l;
  }
  if (G.kind === "done") {
  ...
  let { offer: s, line: T } = G,
    l;
  if (t[9] !== o || t[10] !== s) ((l = () => o(s)), (t[9] = o), (t[10] = s), (t[11] = l));
  else l = t[11];
  let W;
  if (t[12] === p)
    ((W = e(pe, { children: e(F, { chord: "enter", action: "continue" }) })), (t[12] = W));
  else W = t[12];
  let S;
  if (t[13] !== T) ((S = e(n, { children: T })), (t[13] = T), (t[14] = S));
  else S = t[14];
  let O;
  if (t[15] !== o || t[16] !== s)
    ((O = e(N, { onContinue: () => o(s) })), (t[15] = o), (t[16] = s), (t[17] = O));
  else O = t[17];
  let X;
  if (t[18] !== l || t[19] !== S || t[20] !== O)
    ((X = r(me, {
      title: "File sync",
      onCancel: l,
      isCancelActive: !1,
...
function C() {
  ...
  if (Re[0] !== a.keyName || Re[1] !== a.pending)
    ((Y = a.pending
      ? r(n, { dimColor: !0, children: ["Press ", a.keyName, " again to exit"] })
      : null),
      (Re[0] = a.keyName),
      (Re[1] = a.pending),
      (Re[2] = Y));
...
function N(Se) {
  let q = y(6),
    { onContinue: P } = Se,
    Z;
  if (q[0] !== P) ((Z = { "confirm:yes": P, "confirm:no": P }), (q[0] = P), (q[1] = Z));
  else Z = q[1];
  let E;
  if (q[2] === p) ((E = { context: "Confirmation" }), (q[2] = E));
  else E = q[2];
  pt(Z, E);
  let m = Pi(re),
    ee;
  if (q[3] !== m.keyName || q[4] !== m.pending)
    ((ee = m.pending
      ? r(n, { dimColor: !0, children: ["Press ", m.keyName, " again to exit"] })
      : null),
      (q[3] = m.keyName),
      (q[4] = m.pending),
      (q[5] = ee));
