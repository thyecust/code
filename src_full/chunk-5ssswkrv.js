  ...
  no({
    ...
    files: async () => {
      let [{ TEMPLATE_MD: t }, { RUN_EXAMPLE_FILES: e }] = await Promise.all([
        import("./chunk-svng88ye.js"),
        import("./chunk-ykq566q7.js"),
      ]);
      return { "template.md": t, ...e };
    },
    async getPromptForCommand(t) {
      let { SKILL_MD: e } = await import("./chunk-svng88ye.js"),
        r = [ii(e).content.trimStart()];
      if (t)
        r.push(`## User Request
...
export { s as registerRunSkillGeneratorSkill };
