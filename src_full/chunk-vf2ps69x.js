...
import { o, n, Yi } from "./chunk-h8z84shc.js";
...
import { y3e, _3e, pre } from "./chunk-qpwbvc04.js";
...
function O(U) {
  let c = y(16),
    { currentStep: W, sessionId: R } = U,
    [G, Z] = Yi(100),
    P = Math.floor(Z / 100) % i.length,
    V;
  if (c[0] !== W) ((V = (E) => E.key === W), (c[0] = W), (c[1] = V));
  else V = c[1];
  let k = b.findIndex(V);
  const K = i[P];
  let C;
  if (c[2] !== K)
    ((C = e(o, {
      marginBottom: 1,
      children: r(n, { bold: !0, color: "claude", children: [K, " Teleporting session\u2026"] }),
    })),
      (c[2] = K),
      (c[3] = C));
  else C = c[3];
  let x;
  if (c[4] !== R)
    ((x = R && e(o, { marginBottom: 1, children: e(n, { dimColor: !0, children: R }) })),
      (c[4] = R),
      (c[5] = x));
  else x = c[5];
  let v;
  if (c[6] !== k || c[7] !== P)
    ((v = b.map((X, L) => {
      ...
      let w;
      let B;
      if (ee) ((w = N.tick), (B = "green"));
      else if (Y) ((w = i[P]), (B = "claude"));
      else ((w = N.circle), (B = void 0));
      return r(
        o,
        {
          flexDirection: "row",
          children: [
            e(o, { width: 2, children: e(n, { color: B, dimColor: q, children: w }) }),
            e(n, { dimColor: q, bold: Y, children: X.label }),
          ],
        },
        X.key,
      );
  ...
  let D;
  if (c[9] !== v)
    ((D = e(o, { flexDirection: "column", marginLeft: 2, children: v })), (c[9] = v), (c[10] = D));
  else D = c[10];
  let z;
  if (c[11] !== G || c[12] !== C || c[13] !== x || c[14] !== D)
    ((z = r(o, { ref: G, flexDirection: "column", paddingX: 1, paddingY: 1, children: [C, x, D] })),
      (c[11] = G),
      (c[12] = C),
      (c[13] = x),
      (c[14] = D),
...
async function M(T, a, g) {
  let l = () => {};
  function m() {
    let [S, f] = d("validating");
    return ((l = f), e(O, { currentStep: S, sessionId: g }));
  }
  T.render(e(Pf, { session: a, keybindings: !1, children: e(m, {}) }, "teleport-progress"));
  let t = await pre(g, l);
  l("checking_out");
  let { branchName: s, branchError: p } = await _3e(t.branch);
  return { messages: y3e(t.log, p, t.environmentKind), branchName: s };
}
export { O as TeleportProgress, M as teleportWithProgress };
