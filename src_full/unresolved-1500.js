...
import { Fa, St } from "./chunk-x722nt0q.js";
...
import { BF, zue, UV, l0 } from "./chunk-qpwbvc04.js";
...
import { T9 } from "./chunk-614d4vc2.js";
...
import { QU, BGe } from "./chunk-eawgw36a.js";
...
import { wze } from "./chunk-nf6vz5qa.js";
...
import { Ijn } from "./chunk-88pj9ctr.js";
...
function C(me) {
  let i = y(26),
    { sessionDrafts: a, messages: V, renderExitFlow: f, onExit: b } = me,
    { storageV5: L } = ye(),
    [N, de] = d("nudge"),
    [M, K] = d(null),
    q = k(!1),
  ...
  if (i[0] !== a || i[1] !== L)
    ((x = async function h() {
      for (const fe of a) await wze(fe, "exit_nudge", L).catch(z);
    }),
      (i[0] = a),
      (i[1] = L),
      (i[2] = x));
  ...
  let D = A,
    J;
  if (i[6] !== h || i[7] !== M || i[8] !== b || i[9] !== f || i[10] !== N)
    ((J = function B(c) {
      if (N !== "nudge" || M || c.ctrl || c.meta) {
        return;
      }
      if (q.current) {
        c.preventDefault();
      ...
      if (c.key === "return") (c.preventDefault(), de("panel"));
        ...
        if ((c.preventDefault(), (q.current = !0), f)) K(f(h));
        else
          (async () => {
            (await h(), b());
          })();
  ...
  if (N === "panel") {
    let E;
    if (i[12] !== D) ((E = () => D()), (i[12] = D), (i[13] = E));
    else E = i[13];
    let l;
    if (i[14] !== V || i[15] !== E)
      ((l = e(Qxe, { messages: V, onDone: E })), (i[14] = V), (i[15] = E), (i[16] = l));
    else l = i[16];
    return l;
  }
  const E = a.length;
  let l;
  if (i[17] !== a.length) ((l = R(a.length, "feedback draft")), (i[17] = a.length), (i[18] = l));
  else l = i[18];
  let I;
  if (i[19] !== a.length || i[20] !== l)
    ((I = r(n, { children: ["You have ", E, " unsent", " ", l] })),
      (i[19] = a.length),
      (i[20] = l),
      (i[21] = I));
  else I = i[21];
  ...
  if (i[22] === p)
    ((X = e(n, {
      ...
      children: r(pe, {
        children: [
          e(F, { chord: "enter", action: "review & send" }),
          e(F, { chord: "esc", action: "discard and exit" }),
        ],
      }),
    })),
      (i[22] = X));
  ...
  let Y;
  if (i[23] !== B || i[24] !== I)
    ((Y = r(xr, { onKeyDown: B, children: [I, X] })), (i[23] = B), (i[24] = I), (i[25] = Y));
  else Y = i[25];
  return Y;
}
  ...
  let m = Fa() !== null,
    ...
    v =
      m || u.length > 0
        ...
        : null;
  if (l0()) {
    let { queued: g } = await UV({ lightweight: !0 }, o.storageV5).catch(() => ({
        queued: [],
        expired: [],
      })),
      w = g.filter((S) => S.source_session_id === Q());
    if (w.length > 0)
      return e(C, {
        sessionDrafts: w,
        messages: [...o.messages],
        renderExitFlow: v,
        onExit: () => {
          (t(W()), T9(BF(o), { responseStreaming: zue(o) }, o.storageV5));
        },
      });
  }
  if (v) return v();
  return (t(W()), await T9(BF(o), { responseStreaming: zue(o) }, o.storageV5), null);
}
export { Ne as call };
