...
import { b, sye } from "./chunk-fzpv8ev5.js";
...
function E(F) {
  let t = y(19),
    { filePath: R, errorDescription: h, onExit: i, onReset: u } = F,
    v;
  if (t[0] !== i || t[1] !== u)
    ((v = (K) => {
      if (K === "exit") i();
  ...
  let d;
  if (t[5] !== h) ((d = e(n, { children: h })), (t[5] = h), (t[6] = d));
  else d = t[6];
  let c;
  if (t[7] !== m || t[8] !== d)
  ...
  let O;
  if (t[10] === p) ((O = e(n, { bold: !0, children: "Choose an option:" })), (t[10] = O));
  else O = t[10];
  let x;
  if (t[11] === p)
    ((x = [
  ...
  if (t[12] !== _ || t[13] !== i)
    ((g = r(o, {
      ...
      children: [O, e(Re, { options: x, onChange: _, onCancel: i })],
    })),
      (t[12] = _),
      (t[13] = i),
      (t[14] = g));
  ...
  let S;
  if (t[15] !== i || t[16] !== c || t[17] !== g)
    ((S = r(me, { title: "Configuration error", color: "error", onCancel: i, children: [c, g] })),
      (t[15] = i),
      (t[16] = c),
      (t[17] = g),
      (t[18] = S));
    ...
    let { unmount: l } = await uL(
      e(Pf, {
        ...
        children: e(E, {
          ...
          onReset: () => {
            (sye(a.filePath, b(a.defaultConfig, null, 2), { flush: !1, encoding: "utf8" }),
              l(),
              s(),
              process.exit(0));
          },
