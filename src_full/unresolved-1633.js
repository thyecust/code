...
export {
  bxe as appendSlackTagResumeRecords,
  khr as computeRestoredAttributionState,
  gxe as computeStandaloneAgentContext,
  oZt as exitRestoredWorktree,
  pee as installRestoredModel,
  rZt as isHostileRestorePath,
  nZt as lastTranscriptModel,
  dee as loadAgentDefinitionsForSessionCwd,
  eZt as maybeSwitchSessionForResume,
  yxe as neutralizeForkFallbackBanners,
  Git as processResumedConversation,
  mee as rearmRefusalFallbackHeaderFromTranscript,
  Ihr as refreshAgentDefinitionsForModeSwitch,
  X6 as reloadAgentDefinitionsForModeSwitch,
  K4 as restoreAgentFromSession,
  fee as restoreModelFromSession,
  Thr as restorePermissionModeFromSession,
  mxe as restoreSessionStateFromLog,
  J6 as restoreWorktreeForResume,
  Chr as restoredModelIsRefusalFallback,
  tZt as shouldAttemptAgentRestoreInPrint,
  hxe as startupModelWinsOverSessionRestore,
  NLt as worktreeGoneHeadlessNotice,
  _xe as worktreeResumeNotice,
  OLt as worktreeResumeRefusalError,
};
