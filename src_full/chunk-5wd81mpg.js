...
import { HVe } from "./chunk-wgeq16t1.js";
...
var m = async (o, s, t) => {
  let i = t.trim();
  if (!i) return (o("Usage: /fork \\<directive\\>", { display: "system" }), null);
  let r = await HVe(i, s, s.canUseTool ?? qd);
  if (!r)
    return (
      o(
        xs()
  ...
  return (o(`${Rb} forked ${r.name} (${r.agentId.slice(-4)})`, { display: "system" }), null);
};
export { m as call };
