...
import { eue, GY, tue, WWn, hdt, ASe } from "./chunk-tyjmke26.js";
import { kt } from "./chunk-r8hc3n2z.js";
import { Vsn, qsn, Ksn } from "./chunk-zvtkac73.js";
...
var n = m(() =>
  ...
  a = m(() => c({ results: T(eue()), opt_in_required: I(!0).optional(), message: i().optional() })),
  f = kt({
    name: Vsn,
    ...
    async call(e, t) {
      try {
        let r = await WWn(e.keywords, t.abortController.signal, t.credentials);
        if (GY(r)) return { data: { results: [], ...r } };
        let o = t.options.refreshMcpClients?.() ?? t.options.mcpClients;
        return { data: { results: hdt(r, o) } };
      } catch (r) {
    ...
    mapToolResultToToolResultBlockParam(e, t) {
      return { tool_use_id: t, type: "tool_result", content: b(e.opt_in_required ? e : e.results) };
    },
    renderToolUseMessage(e) {
      return (e.keywords ?? []).join(", ");
    },
  });
export { f as SearchMcpRegistryTool };
